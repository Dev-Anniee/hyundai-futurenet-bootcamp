...
public class Ex03_Lamda {
	public static void main(String[] args) {
		MyFunction myFunction = new MyFunction() {
			...
			@Override
			public void method() {
				System.out.println("익명 클래스 강제 구현");
				
			}
		}; myFunction.method();
		
		
		// @FunctionalInterface 함수적 인터페이스 (현대적인 코드 : 람다식 줄여보자)
		// method()를 구현한 람다식 정의 
		MyFunction myFunction2 = ()-> System.out.println("익명 클래스 강제 구현");
		myFunction2.method();
