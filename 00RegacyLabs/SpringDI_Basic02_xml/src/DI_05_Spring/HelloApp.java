...
public class HelloApp {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
		 DI_05_Spring.MyBean@683dbc2c
		 DI_05_Spring.MyBean@683dbc2c
		 DI_05_Spring.MyBean@683dbc2c 
		 */
		MyBean m4 = context.getBean("myBean3",MyBean.class);
		System.out.println(m4);  //DI_05_Spring.MyBean@68267da0
		...
		System.out.println(single);
		/*
		  DI_05_Spring.Singleton@2638011
		  DI_05_Spring.Singleton@2638011 
		...
		/*
		 ...
		 4. * 예외적으로 getBean() .. new 라는 용도로 사용가능(거의 사용하지 않는다 =prototype) 
